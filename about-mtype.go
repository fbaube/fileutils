...
//  [0] XML, HTML, BIN, TXT, MKDN [we keep XML and HTML distinct because
//      in the Go stdlib, they have quite different processing, and we take
//      advantage of it to keep HTML processing free of nasty surprises]
